...
describe('webu.sha3', function () {
    it('should return sha3 with hex prefix', function() {
	test1 = webu.sha3('test123');
	test2 = webu.sha3('test(int)');
	test3 = webu.sha3('0x80', {encoding: 'hex'});
	test4 = webu.sha3('0x3c9229289a6125f7fdf1885a77bb12c37a8d3b4962d936f7e3084dece32a3ca1', {encoding: 'hex'});
