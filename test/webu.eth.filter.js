...
describe('webu.huc', function() {
    describe(method, function() {
        webu.setProvider(new webu.providers.HttpProvider('http://localhost:3050'));
        tests.forEach(function(test, index) {
            ...
            it('should call filterCreationErrorCallback on error while filter creation',
                function() {
                    // given
                    // var provider = new FakeHttpProvider();
                    webu.reset();
