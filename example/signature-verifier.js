...
function initializeEthereumConnection(){
  ...
  ethWeb3 = new Webu(new Webu.providers.HttpProvider(ethURL));

  if(ethWeb3.isConnected()==true){
      if(defaultAc==''){
        defaultAc=ethWeb3.huc.accounts[1];
      }
      return true;
  }
...
function initializeContract(){
    ...
    var contract = ethWeb3.huc.contract(abi);
...
function signMessage(message){
    ...
    const sig = ethWeb3.huc.sign(defaultAc, '0x' + msg.toString('hex'));
